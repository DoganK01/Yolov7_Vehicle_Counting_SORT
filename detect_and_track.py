...
def save(im0, bbox, c, id, path):
  bb=im0[int(bbox[1]):int(bbox[3]),int(bbox[0]):int(bbox[2])]
  print(bb)

  path1 = "/content/drive/MyDrive/yolov7_object_tracking/Counting"
  path2=os.path.join(path1, path)
  bb_resized=cv2.resize(bb,(224,224))
  sttring = f"{path}_{id}_{c}.jpg"
  

  new = cv2.imwrite(os.path.join(path2, sttring), bb_resized)
  c = c + 1
  return c
...
def intersect(line, cx, cy):

  return line[0][0] < cx < line[1][0] and line[0][1] - 5 < cy < line[1][1] + 5

#............................... Bounding Boxes Drawing ............................
"""Function to Draw Bounding boxes"""
def draw_boxes(img, bbox, a, b, identities=None, categories=None, names=None, save_with_object_id=False, path=None,offset=(0, 0)):
              ...
              if totalCount.count(id) == 0:
                ...
                if "South" in direction:
                    if obj_name not in object_counter:
                        ...
                        object_counter[obj_name] += 1
                    a = save(img, box, a, id, path = "Leaving")
                if "North" in direction:
                    if obj_name not in object_counter1:
                        object_counter1[obj_name] = 1
                    else:
                        object_counter1[obj_name] += 1
                    b = save(img, box, b, id, path = "Entering")
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if len(det):
                ...
                if len(tracked_dets)>0:
                    ...
                    draw_boxes(im0, bbox_xyxy, a, b, identities, categories, names, save_with_object_id, txt_path)
